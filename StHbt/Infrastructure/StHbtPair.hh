 ...
 * changed ambiguous StHbtPair::fourMomentum() to fourMomentumSum() and fourMomentumDiff() and fixed related bug in
 *QvecCorrFctn
 *
...
public:
	...
	// StHbtLorentzVector defined in StHbtVector derived from StLorentzVectorD
...
private:
	...
	void CalcMergingParFctn(
		short *tmpMergingParNotCalculatedFctn, float *tmpZ1, float *tmpU1, float *tmpZ2, float *tmpU2, int *tmpSect1,
		int *tmpSect2, double *tmpFracOfMergedRow, double *tmpClosestRowAtDCA
	) const;
...
inline double StHbtPair::getFracOfMergedRowTrkV0Pos() const {
	if (mMergingParNotCalculatedTrkV0Pos)
		CalcMergingParFctn(
			&mMergingParNotCalculatedTrkV0Pos, &(mTrack1->mZ[0]), &(mTrack1->mU[0]), &(mTrack2->mZ[0]),
			&(mTrack2->mU[0]), &(mTrack1->mSect[0]), &(mTrack2->mSect[0]), &(mFracOfMergedRowTrkV0Pos),
...
inline double StHbtPair::getFracOfMergedRowTrkV0Neg() const {
	if (mMergingParNotCalculatedTrkV0Neg)
		CalcMergingParFctn(
			&mMergingParNotCalculatedTrkV0Neg, &(mTrack1->mZ[0]), &(mTrack1->mU[0]), &(mTrack2->mV0NegZ[0]),
			&(mTrack2->mV0NegU[0]), &(mTrack1->mSect[0]), &(mTrack2->mV0NegSect[0]), &(mFracOfMergedRowTrkV0Neg),
...
inline double StHbtPair::getFracOfMergedRowV0PosV0Neg() const {
	if (mMergingParNotCalculatedV0PosV0Neg)
		CalcMergingParFctn(
			&mMergingParNotCalculatedV0PosV0Neg, &(mTrack1->mZ[0]), &(mTrack1->mU[0]), &(mTrack2->mV0NegZ[0]),
			&(mTrack2->mV0NegU[0]), &(mTrack1->mSect[0]), &(mTrack2->mV0NegSect[0]), &(mFracOfMergedRowV0PosV0Neg),
...
inline double StHbtPair::getFracOfMergedRowV0NegV0Pos() const {
	if (mMergingParNotCalculatedV0NegV0Pos)
		CalcMergingParFctn(
			&mMergingParNotCalculatedV0NegV0Pos, &(mTrack1->mV0NegZ[0]), &(mTrack1->mV0NegU[0]), &(mTrack2->mZ[0]),
			&(mTrack2->mU[0]), &(mTrack1->mV0NegSect[0]), &(mTrack2->mSect[0]), &(mFracOfMergedRowV0NegV0Pos),
...
inline double StHbtPair::getFracOfMergedRowV0PosV0Pos() const {
	if (mMergingParNotCalculatedV0PosV0Pos)
		CalcMergingParFctn(
			&mMergingParNotCalculatedV0PosV0Pos, &(mTrack1->mZ[0]), &(mTrack1->mU[0]), &(mTrack2->mZ[0]),
			&(mTrack2->mU[0]), &(mTrack1->mSect[0]), &(mTrack2->mSect[0]), &(mFracOfMergedRowV0PosV0Pos),
...
inline double StHbtPair::getFracOfMergedRowV0NegV0Neg() const {
	if (mMergingParNotCalculatedV0NegV0Neg)
		CalcMergingParFctn(
			&mMergingParNotCalculatedV0NegV0Neg, &(mTrack1->mV0NegZ[0]), &(mTrack1->mV0NegU[0]), &(mTrack2->mV0NegZ[0]),
			&(mTrack2->mV0NegU[0]), &(mTrack1->mV0NegSect[0]), &(mTrack2->mV0NegSect[0]), &(mFracOfMergedRowV0NegV0Neg),
