...
#include "Base/StHbtBaseAnalysis.h"        // base analysis class
#include "Infrastructure/StHbtTypes.hh"
#include "Base/StHbtEventCut.h"             // base class 
#include "Base/StHbtParticleCut.h"          // base class
#include "Base/StHbtPairCut.h"              // base class
#include "Base/StHbtLikeSignCorrFctn.hh"    // base class
#include "Infrastructure/StHbtAnalysis.h"
#include "Infrastructure/StHbtCorrFctnCollection.hh"
