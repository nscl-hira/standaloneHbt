...
#include "Infrastructure/StHbtV0Collection.hh"
#include "Infrastructure/StHbtXiCollection.hh"
#include "Infrastructure/StHbtKinkCollection.hh"
...
public:
  ...
  void Rotate3D(const double theta, const double phi);     
  ...
  void SetEtrans(const float&);
  float GetEtrans() const;
	
  void SetBhat(const float&);
  float GetBhat() const;
  
  void SetuBallDS_TRG(const float&);
  float GetuBallDS_TRG() const;
  
  void SetuBallHira_TRG(const float&);
  float GetuBallHira_TRG() const;
  
  void SetuBallNW_TRG(const float&);
  float GetuBallNW_TRG() const;
