...
#include "Infrastructure/StHbtManager.h"
...
int StHbtManager::ProcessEvent(){
  ...
  //check if the particles are loaded for each event
  /*
  StHbtTrackIterator TractIter;
  for (TractIter=currentHbtEvent->TrackCollection()->begin();TractIter!=currentHbtEvent->TrackCollection()->end();TractIter++)
  {
	  cout<<(*TractIter)->GetEnLab()<<endl;
  }
  */
