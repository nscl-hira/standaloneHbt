...
public:
	...
	void CalculateTpcExitAndEntrancePoints(
	...
	/*   int GetEventRunNumber() const;
	  int GetEventMulti() const;
	  double GetEventBhat() const; */
...
inline double StHbtParticle::GetWeight() const { return mTrack->GetWeight(); }

inline int StHbtParticle::GetPid() const { return mTrack->GetPid(); }

inline int StHbtParticle::Charge() const { return mTrack->Charge(); }

inline unsigned short StHbtParticle::GetTelescope() const { return mTrack->GetTelescope(); }

inline unsigned short StHbtParticle::GetEFStrip() const { return mTrack->GetEFStrip(); }

inline unsigned short StHbtParticle::GetEBStrip() const { return mTrack->GetEBStrip(); }

inline unsigned short StHbtParticle::GetCsI() const { return mTrack->GetCsI(); }

inline double StHbtParticle::GetEnLab() const { return mTrack->GetEnLab(); }

inline double StHbtParticle::GetPzLab() const { return mTrack->GetPzLab(); }
