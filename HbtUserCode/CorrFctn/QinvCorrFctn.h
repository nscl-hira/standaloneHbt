...
inline  TH1D* QinvCorrFctn::Numerator(){return mNumerator;}
inline  TH1D* QinvCorrFctn::Denominator(){return mDenominator;}
inline  TH1D* QinvCorrFctn::Ratio(){return mRatio;}
