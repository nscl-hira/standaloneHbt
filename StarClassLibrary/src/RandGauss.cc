...
HepDouble RandGauss::operator()() { return fire(); }
...
void RandGauss::shootArray(const HepInt size, HepDouble *vect, HepDouble mean, HepDouble stdDev) {
	HepInt i;
...
void RandGauss::shootArray(
	HepRandomEngine *anEngine, const HepInt size, HepDouble *vect, HepDouble mean, HepDouble stdDev
) {
	HepInt i;
...
void RandGauss::fireArray(const HepInt size, HepDouble *vect, HepDouble mean, HepDouble stdDev) {
	HepInt i;
