...
HepDouble RandExponential::operator()() { return fire(); }

void RandExponential::shootArray(const HepInt size, HepDouble *vect, HepDouble mean) {
	HepInt i;
...
void RandExponential::shootArray(HepRandomEngine *anEngine, const HepInt size, HepDouble *vect, HepDouble mean) {
...
void RandExponential::fireArray(const HepInt size, HepDouble *vect, HepDouble mean) {
	HepInt i;
