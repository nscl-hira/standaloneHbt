...
HepDouble RandPoisson::operator()() { return HepDouble(fire()); }
...
HepDouble gammln(HepDouble xx) {
	...
	static HepDouble cof[6] = {76.18009172947146,  -86.50532032941677,	  24.01409824083091,
...
void RandPoisson::shootArray(HepRandomEngine *anEngine, const HepInt size, long *vect, HepDouble m) {
	HepInt i;
