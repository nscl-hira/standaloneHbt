...
HepDouble RandBreitWigner::operator()() { return fire(); }
...
void RandBreitWigner::shootArray(const HepInt size, HepDouble *vect, HepDouble a, HepDouble b, HepDouble c) {
	HepInt i;
...
HepDouble RandBreitWigner::shoot(HepRandomEngine *anEngine, HepDouble mean, HepDouble gamma) {
	HepDouble rval, displ;
...
HepDouble RandBreitWigner::shoot(HepRandomEngine *anEngine, HepDouble mean, HepDouble gamma, HepDouble cut) {
	HepDouble val, rval, displ;
...
HepDouble RandBreitWigner::shootM2(HepRandomEngine *anEngine, HepDouble mean, HepDouble gamma) {
	HepDouble val, rval, displ;
...
HepDouble RandBreitWigner::shootM2(HepRandomEngine *anEngine, HepDouble mean, HepDouble gamma, HepDouble cut) {
	HepDouble rval, displ;
	HepDouble lower, upper, tmp;
...
void RandBreitWigner::shootArray(
	HepRandomEngine *anEngine, const HepInt size, HepDouble *vect, HepDouble a, HepDouble b, HepDouble c
) {
	HepInt i;
...
void RandBreitWigner::fireArray(const HepInt size, HepDouble *vect, HepDouble a, HepDouble b, HepDouble c) {
	HepInt i;
